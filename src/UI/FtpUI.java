...
import Persistence.Modules.FtpPersistence.FtpConfig;
import Persistence.Worker1.Worker1Persistence;
import Service.FtpClient;
...
public class FtpUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dirRemotoTF = new javax.swing.JTextField();
        dirRemotoL = new javax.swing.JLabel();
        ...
        setTitle("NTA - Configuração de monitoramento (FTP)");
        ...
        dirRemotoTF.setFont(new java.awt.Font("SansSerif", 0, 13)); // NOI18N
        dirRemotoTF.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                dirRemotoTFFocusGained(evt);
            }
        });
        dirRemotoTF.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                dirRemotoTFMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                dirRemotoTFMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                dirRemotoTFMouseExited(evt);
            }
        });
        dirRemotoTF.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                dirRemotoTFActionPerformed(evt);
            }
        });
        dirRemotoTF.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                dirRemotoTFKeyReleased(evt);
            }
        });
        getContentPane().add(dirRemotoTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 340, 340, -1));

        dirRemotoL.setFont(new java.awt.Font("SansSerif", 0, 13)); // NOI18N
        dirRemotoL.setText("Diretório Remoto");
        getContentPane().add(dirRemotoL, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 320, -1, -1));
        ...
        operacaoCHB.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Autenticação", "Upload", "Download", "Listar arquivos", "Truncar diretório" }));
        ...
        getContentPane().add(operacaoCHB, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 340, 140, 20));

        dirLocalTF.setFont(new java.awt.Font("SansSerif", 0, 13)); // NOI18N
        dirLocalTF.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                dirLocalTFFocusGained(evt);
            }
        });
        dirLocalTF.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                dirLocalTFMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                dirLocalTFMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                dirLocalTFMouseExited(evt);
            }
        });
        dirLocalTF.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                dirLocalTFActionPerformed(evt);
            }
        });
        dirLocalTF.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                dirLocalTFKeyReleased(evt);
            }
        });
        getContentPane().add(dirLocalTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 390, 520, -1));

        valorAnteriorL.setFont(new java.awt.Font("SansSerif", 0, 13)); // NOI18N
        valorAnteriorL.setText("Diretório Local");
    ...
    private void fundoPlayAction() {
        ...
        ftp = new FtpClient(usuarioTF.getText(), hostTF.getText(), new String(senhaPF.getPassword()), dirRemotoTF.getText(), dirLocalTF.getText(), portaTF.getText(), protocoloCHB.getSelectedItem().toString());

        switch (operacaoCHB.getSelectedIndex()) {
            case 0:
                //Autenticação
                addToArray(ftp.ftpAuth());
                break;
            case 1: {
                //Upload
                addToArray(ftp.ftpAuth());
                addToArray(ftp.ftpUpload());
            }
            break;
            case 2:
                //Download
                addToArray(ftp.ftpAuth());
                addToArray(ftp.ftpDownload());
                break;
            case 3:
                //Listar arquivos
                addToArray(ftp.ftpAuth());
                addToArray(ftp.ftpListFiles());
                break;
            case 4:
                //Truncar diretório
                addToArray(ftp.ftpAuth());
                addToArray(ftp.ftpTruncateDirectory());
    ...
    private void dirRemotoTFFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_dirRemotoTFFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_dirRemotoTFFocusGained

    private void dirRemotoTFMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dirRemotoTFMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_dirRemotoTFMouseClicked

    private void dirRemotoTFMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dirRemotoTFMouseEntered
        remoteHostFundo.setBorder(new RoundedBorder(Color.BLUE, 3, 20));
        setTextInfoButton("Informe o diretório destino.");
    }//GEN-LAST:event_dirRemotoTFMouseEntered

    private void dirRemotoTFMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dirRemotoTFMouseExited
        defaultInfoButtonTxt();
    }//GEN-LAST:event_dirRemotoTFMouseExited

    private void dirRemotoTFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dirRemotoTFActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_dirRemotoTFActionPerformed

    private void dirRemotoTFKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_dirRemotoTFKeyReleased
        persistirInformacoes();
    }//GEN-LAST:event_dirRemotoTFKeyReleased
    ...
    private void operacaoCHB() {
        switch (operacaoCHB.getSelectedIndex()) {
            case 0:
                //Autenticação
                dirRemotoTF.setEnabled(false);
                dirLocalTF.setEnabled(false);
                break;
            case 1:
                //Upload
                dirRemotoTF.setEnabled(true);
                dirLocalTF.setEnabled(true);
                break;
            case 2:
                //Download
                dirRemotoTF.setEnabled(true);
    ...
    private void dirLocalTFFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_dirLocalTFFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_dirLocalTFFocusGained

    private void dirLocalTFMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dirLocalTFMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_dirLocalTFMouseClicked
    ...
    private void dirLocalTFMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dirLocalTFMouseExited
        defaultInfoButtonTxt();
    }//GEN-LAST:event_dirLocalTFMouseExited

    private void dirLocalTFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dirLocalTFActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_dirLocalTFActionPerformed
    ...
    public void persistirInformacoes() {
        ...
        config.session = new FtpConfig.SessionValues();
        ...
        config.session.diretorioRemoto = dirRemotoTF.getText();
        config.session.operacao = operacaoCHB.getSelectedIndex();
        config.session.diretorioLocal = dirLocalTF.getText();
    ...
    public void carregarInformacoes() {
        ...
        try {
            ...
            dirRemotoTF.setText(config.session.diretorioRemoto);
            operacaoCHB.setSelectedIndex(config.session.operacao);
            dirLocalTF.setText(config.session.diretorioLocal);
        } catch (Exception e) {
    ...
    public void addMonitoring() {
        ...
        String workspace = "FTP";

        Worker1Persistence.SessionValues novoMonitoramento = new Worker1Persistence.SessionValues();
        novoMonitoramento.ftp_DiretorioAtual = dirLocalTF.getText();
        novoMonitoramento.ftp_DiretorioRemoto = dirRemotoTF.getText();
    ...
    private javax.swing.JLabel dirRemotoL;
    private javax.swing.JTextField dirRemotoTF;
