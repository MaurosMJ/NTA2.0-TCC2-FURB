...
public class HttpUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        parametrosTF = new javax.swing.JTextField();
        ...
        setTitle("NTA - Configuração de monitoramento (HTTP)");
        ...
        endPointTF.setFont(new java.awt.Font("SansSerif", 0, 13)); // NOI18N
        endPointTF.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                endPointTFFocusGained(evt);
            }
        });
        endPointTF.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                endPointTFMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                endPointTFMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                endPointTFMouseExited(evt);
            }
        });
        endPointTF.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                endPointTFActionPerformed(evt);
            }
        });
        endPointTF.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                endPointTFKeyReleased(evt);
            }
        });
        getContentPane().add(endPointTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 240, 360, 30));

        hostL.setFont(new java.awt.Font("SansSerif", 0, 13)); // NOI18N
        hostL.setText("Endpoint");
        getContentPane().add(hostL, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 220, -1, -1));
        ...
        getContentPane().add(protocoloL, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 220, -1, 20));

        protocoloCHB.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Http", "Https" }));
        ...
        getContentPane().add(protocoloCHB, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 240, 140, 30));

        parametrosTF.setFont(new java.awt.Font("SansSerif", 0, 13)); // NOI18N
        parametrosTF.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                parametrosTFFocusGained(evt);
            }
        });
        parametrosTF.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                parametrosTFMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                parametrosTFMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                parametrosTFMouseExited(evt);
            }
        });
        parametrosTF.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                parametrosTFActionPerformed(evt);
            }
        });
        parametrosTF.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                parametrosTFKeyReleased(evt);
            }
        });
        getContentPane().add(parametrosTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 290, 360, 30));

        urlTF.setFont(new java.awt.Font("SansSerif", 0, 13)); // NOI18N
        ...
        urlTF.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                urlTFFocusGained(evt);
            }
        });
        urlTF.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                urlTFMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                urlTFMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                urlTFMouseExited(evt);
            }
        });
        ...
        getContentPane().add(urlTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 384, 520, 30));

        corpoEmailL.setFont(new java.awt.Font("SansSerif", 1, 13)); // NOI18N
        corpoEmailL.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        corpoEmailL.setText("URL Formatada");
        getContentPane().add(corpoEmailL, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 360, 520, -1));

        remetenteL.setFont(new java.awt.Font("SansSerif", 0, 13)); // NOI18N
        remetenteL.setText("Parametros");
        getContentPane().add(remetenteL, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 270, -1, -1));

        operacaoCHB.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Get", "Put" }));
        ...
        getContentPane().add(operacaoCHB, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 290, 140, 30));

        protocoloL1.setFont(new java.awt.Font("SansSerif", 0, 13)); // NOI18N
        protocoloL1.setText("Operação");
        getContentPane().add(protocoloL1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 270, -1, 20));
        ...
        getContentPane().add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 340, 520, 10));

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void endPointTFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_endPointTFActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_endPointTFActionPerformed
    ...
    }//GEN-LAST:event_endPointTFFocusGained

    private void endPointTFMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_endPointTFMouseClicked
        // TODO add your handling code here:
        remoteHostFundo.setBorder(new RoundedBorder(Color.BLUE, 3, 20));
    }//GEN-LAST:event_endPointTFMouseClicked

    private void endPointTFKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_endPointTFKeyReleased
        formatarURL();
        persistirInformacoes();
    }//GEN-LAST:event_endPointTFKeyReleased
    ...
    private void endPointTFMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_endPointTFMouseExited
        // TODO add your handling code here:
        defaultInfoButtonTxt();
    }//GEN-LAST:event_endPointTFMouseExited
    ...
    private void parametrosTFFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_parametrosTFFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_parametrosTFFocusGained

    private void parametrosTFMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_parametrosTFMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_parametrosTFMouseClicked
    ...
    private void parametrosTFMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_parametrosTFMouseExited
        defaultInfoButtonTxt();
    }//GEN-LAST:event_parametrosTFMouseExited

    private void parametrosTFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_parametrosTFActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_parametrosTFActionPerformed

    private void parametrosTFKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_parametrosTFKeyReleased
        formatarURL();
        persistirInformacoes();
    }//GEN-LAST:event_parametrosTFKeyReleased

    private void urlTFFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_urlTFFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_urlTFFocusGained

    private void urlTFMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_urlTFMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_urlTFMouseClicked
    ...
    private void urlTFMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_urlTFMouseExited
        defaultInfoButtonTxt();
    }//GEN-LAST:event_urlTFMouseExited
...
public Map<String, String> parseParametersString(String parameters) {
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(HttpUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    ...
    public void persistirInformacoes() {
        ...
        config.session = new HttpConfig.SessionValues();
        ...
        config.session.url = urlTF.getText();

        //*Module Configs
        config.session.protocolo = protocoloCHB.getSelectedIndex();
        config.session.endpoint = endPointTF.getText();
    ...
    public void carregarInformacoes() {
        ...
        try {
            endPointTF.setText(config.session.endpoint);
            protocoloCHB.setSelectedIndex(config.session.protocolo);
            parametrosTF.setText(config.session.parametros);
            urlTF.setText(config.session.url);
    ...
    private void formatarURL() {
        urlTF.setText(protocoloCHB.getSelectedItem().toString().toLowerCase() + "://" + endPointTF.getText());
    }
    ...
    private javax.swing.JTextField parametrosTF;
