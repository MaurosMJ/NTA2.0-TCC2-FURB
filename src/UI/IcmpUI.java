...
import Persistence.Modules.IcmpPersistence.IcmpConfig;
import Persistence.Worker1.Worker1Persistence;
import Service.IcmpClient;
...
public class IcmpUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        qtdCHB = new javax.swing.JComboBox();
        ...
        setTitle("NTA - Configuração de monitoramento (ICMP)");
        ...
        valorTF.setFont(new java.awt.Font("SansSerif", 0, 13)); // NOI18N
        valorTF.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                valorTFFocusGained(evt);
            }
        });
        valorTF.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                valorTFMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                valorTFMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                valorTFMouseExited(evt);
            }
        });
        ...
        getContentPane().add(valorTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 240, 90, -1));
        ...
        getContentPane().add(rHostTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 240, 270, -1));
        ...
        qtdCHB.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "1", "2", "3", "4", "5", "6", "7", "8", "9", "Outro" }));
        qtdCHB.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
        ...
        getContentPane().add(ppadraoL, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 220, -1, -1));
    ...
    private void rHostTFKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_rHostTFKeyReleased
        // TODO add your handling code here:
        nomeRHost.setText((rHostTF.getText() + ":" + valorTF.getText()));
    ...
    private void fundoPlayAction() {
        String qtd = "";
        if ("".equals(valorTF.getText())) {
            qtd = qtdCHB.getSelectedItem().toString();
        } else {
            qtd = valorTF.getText();
        }
        ...
        icmp = new IcmpClient(rHostTF.getText(), qtd);
        addToArray(icmp.PerformServerConnection());
    ...
    private void qtdCHBItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_qtdCHBItemStateChanged
        operacaoCHB();
        persistirInformacoes();
    }//GEN-LAST:event_qtdCHBItemStateChanged
    ...
    private void valorTFMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_valorTFMouseExited
        // TODO add your handling code here:
        defaultInfoButtonTxt();
    }//GEN-LAST:event_valorTFMouseExited
    ...
    private void valorTFMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_valorTFMouseClicked
        // TODO add your handling code here:
        remoteHostFundo.setBorder(new RoundedBorder(Color.BLUE, 3, 20));
    }//GEN-LAST:event_valorTFMouseClicked

    private void valorTFFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_valorTFFocusGained
        // TODO add your handling code here:
        remoteHostFundo.setBorder(new RoundedBorder(Color.BLUE, 3, 20));
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(IcmpUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    ...
    public void persistirInformacoes() {
        IcmpConfig config = new IcmpConfig();
        config.workspace = String.valueOf(workspaceCBX.getSelectedItem());
        config.session = new IcmpConfig.SessionValues();
        ...
        if ("".equals(valorTF.getText())) {
            config.session.quantidade = qtdCHB.getSelectedItem().toString();
        } else {
            config.session.quantidade = valorTF.getText();
        }
    ...
    public void carregarInformacoes() {
        ...
        try {
            ...
            valorTF.setText(config.session.quantidade);
    ...
    public void addMonitoring() {
        ...
        String workspace = "ICMP";

        Worker1Persistence.SessionValues novoMonitoramento = new Worker1Persistence.SessionValues();
        if ("".equals(valorTF.getText())) {
            novoMonitoramento.icmp_Quantidade = qtdCHB.getSelectedItem().toString();
        } else {
            novoMonitoramento.icmp_Quantidade = valorTF.getText();
        }
    ...
    public void operacaoCHB() {
        if (!"Outro".equals(qtdCHB.getSelectedItem().toString())) {
            valorTF.setText("");
            valorTF.setEditable(false);
        } else {
    ...
    private javax.swing.JComboBox qtdCHB;
