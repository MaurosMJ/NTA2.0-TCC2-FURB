 ...
 * @author Mauros
 */
public class NtpUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("NTA - Configuração de monitoramento (NTP)");
        ...
        getContentPane().add(rHostTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 240, 490, -1));
    ...
    private void fundoPlayAction() {
        ...
        ntp = new NtpClient(rHostTF.getText());
        addToArray(ntp.PerformServerConnection());
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(NtpUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    ...
    public void persistirInformacoes() {
        NtpConfig config = new NtpConfig();
        config.workspace = String.valueOf(workspaceCBX.getSelectedItem());
        config.session = new NtpConfig.SessionValues();
