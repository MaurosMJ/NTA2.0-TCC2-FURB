...
public class SmtpUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(addMonitoringL, new org.netbeans.lib.awtextra.AbsoluteConstraints(214, 464, 60, 50));
    ...
    private void fundoRecycleBinAction() {
        ...
        senhaPF.setText("");
        protocoloTF.setSelectedIndex(0);
        remetenteTF.setText("");
        destinatarioTF.setText("");
        tituloTF.setText("");
        corpoEmailTF.setText("");
        startTlsCHB.setSelected(true);
        relayCHB.setSelected(false);
        autenticacaoCHB.setSelected(true);
    ...
    public void addMonitoring() {
        ...
        String workspace = "SMTP";

        Worker1Persistence.SessionValues novoMonitoramento = new Worker1Persistence.SessionValues();
        novoMonitoramento.smtp_CorpoEmail = corpoEmailTF.getText();
        novoMonitoramento.smtp_Destinatario = destinatarioTF.getText();
        novoMonitoramento.smtp_IsAutenticacao = autenticacaoCHB.isSelected();
        novoMonitoramento.smtp_IsRelay = relayCHB.isSelected();
