...
public class SshUI extends javax.swing.JFrame {
    ...
    public void addMonitoring() {
        ...
        String workspace = "SSH";

        Worker1Persistence.SessionValues novoMonitoramento = new Worker1Persistence.SessionValues();
        novoMonitoramento.ssh_Porta = rHostPortTF.getText();
        novoMonitoramento.ssh_Servidor = rHostPortTF.getText();
        novoMonitoramento.ssh_Usuario = usuarioTF.getText();
        novoMonitoramento.ssh_Senha = new String(senhaPWF.getPassword());
        novoMonitoramento.ssh_Instrucao = promptTF.getText();
